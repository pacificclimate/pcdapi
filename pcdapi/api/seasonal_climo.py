'''module for requesting seasonal station climatologies
'''

from dateutil.parser import parse
from geojson import Feature, Point, FeatureCollection

def seasonal_climo(sesh, date, variable):
    '''Provides seasonal climatological values for all stations by date

    The `seasonal_climo` call is intended to provide easy client side 
    mapping of seasonal climatological values
